...
{
//    [TR_HttpClient upLoadImageArrayWithUrlString:POST_UPLOAD withDic:nil imageArray:parameter upLoadProgress:^(float progress) {
//
//    } success:^(NSDictionary *requestDic, NSString *msg) {
//        NSMutableArray *picArray = [NSMutableArray array];
//        if ([requestDic objectForKey:@"urls"]) {
//           picArray = [requestDic objectForKey:@"urls"];
//        }
//        BLOCK_EXEC(block,picArray,msg);
//    } failure:^(NSString *errorInfo) {
//        BLOCK_EXEC(block,[NSMutableArray array],errorInfo);
//    }];
