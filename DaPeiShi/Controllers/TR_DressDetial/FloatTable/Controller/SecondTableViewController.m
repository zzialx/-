...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TR_LikeTeacherCell *cell = [tableView dequeueReusableCellWithIdentifier:@"TR_LikeTeacherCell"];
    if (cell==nil) {
        cell=[[[NSBundle mainBundle]loadNibNamed:@"TR_LikeTeacherCell" owner:self options:nil]lastObject];
    }
    return cell;
}
