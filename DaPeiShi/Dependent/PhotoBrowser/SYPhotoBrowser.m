...
@interface SYPhotoBrowser () <UIScrollViewDelegate,SYPhotoDelegate>
...
#pragma mark -- 获取打开相册权限
-(void)getAlbumReject{
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"提示" message:@"是否前往设置中授权茶易购相册访问权限" preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *actionYes = [UIAlertAction actionWithTitle:@"前往" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        [self openAlbumReject];
    }];
