...
-(void)drawRect:(CGRect)rect{
    ...
    CGContextAddLineToPoint(context, TrangleWidth/2, 0);
    CGContextAddLineToPoint(context, TrangleWidth/2, CollectionHeight/2);
    CGContextAddLineToPoint(context, 0, CollectionHeight/2);
...
-(DYTriangleView *)triangle{
    if (!_triangle) {
        _triangle = [[DYTriangleView alloc]initWithFrame:CGRectMake(self.bounds.size.width/2-0.5-TrangleWidth/4, CGRectGetMaxY(_valueTF.frame)-5, TrangleWidth/2, CollectionHeight/2-20)];
