...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, self.kf_width, self.kf_height)];
...
-(void)setKImageView:(NSString *)image{
    //拍照 10174123.jpg
        [self.imageView sd_setImageWithURL:[NSURL URLWithString:image] placeholderImage:[UIImage imageNamed:@"phonelogo"]];
    [self resizeSubviews];
}
