...
//@property (strong, nonatomic) YH_PhotoBottomActionView *actionView;
...
//    [self.actionView updateWithAssets:self.selectAssets];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.nColumnCount >= 4) {
        image = [ASSETHELPER getImageAtIndex:indexPath.row type:ASSET_PHOTO_THUMBNAIL];
    } else {
...
//                [weakSelf.actionView updateWithAssets:weakSelf.selectAssets];
