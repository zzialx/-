...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        [self setImage:[UIImage imageNamed:@"cmt_arrow_down"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"cmt_arrow_up"] forState:UIControlStateSelected];
